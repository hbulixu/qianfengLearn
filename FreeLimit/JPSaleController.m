...
@interface JPSaleController ()<JPLimitFreeContentViewDelegate>
...
@implementation JPSaleController
...
#pragma mark－ 获取降价模型数据
-(void)sendRequst
{
    [MMProgressHUD setPresentationStyle:MMProgressHUDPresentationStyleShrink];
    [MMProgressHUD showWithTitle:nil status:@"正在加载数据"];
    
    NSString *urlString = @"http://iappfree.candou.com:8080/free/applications/sales?currency=rmb&page=1&category_id=";
